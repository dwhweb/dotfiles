...
" Conquer of completion requires nodejs to run, install that first
" Will install plugins for general webdev on first install, seems to be slow
" so give it a second.
"Plug 'neoclide/coc.nvim', {'branch': 'release', 'do' : ':CocInstall coc-rome'}
...
"Distinguished theme configuration
